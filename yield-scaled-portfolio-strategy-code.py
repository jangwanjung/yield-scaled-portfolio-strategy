...
class SCurveYieldScaledMacroRotation(QCAlgorithm):
    ...
    4. 금리대별 포트폴리오 목표 비중 예시 (수학적 정확값)
       -------------------------------------------------------------------------
       DGS30 금리   채권 비중   SCHD(배당)   SPY(대형)   QQQ(성장)   GLD(금)
       -------------------------------------------------------------------------
         2.0% 이하     0.2%       49.9%       29.9%       10.0%      10.0%
         3.2%         4.0%       48.0%       28.7%        9.3%      10.0%
         4.0% (중립)  12.5%       43.8%       25.8%        7.9%      10.0%
         4.8%        21.0%       39.5%       23.0%        6.5%      10.0%
    ...
    6. 리밸런싱 트리거 조건 (매일 장 시작 30분 후 체크)
       ...
       - [조건 2] 프록시 ETF -> 실물 ETF 상장 스위칭일 (VIG->SCHD, TLT->EDV->ZROZ 등)
    ================================================================================
    """
